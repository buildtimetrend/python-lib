...
def get_dashboard_keen_config(repo):
    """
    Generates the Keen.io settings for the configuration of the dashboard.
...
def get_dashboard_config(repo, extra=None):
    """
    Generates the configuration settings for the dashboard.
...
def generate_dashboard_config_file(repo):
    """
    Generates the configuration file for the dashboard.
